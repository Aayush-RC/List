...
lst1 = ['orange','grapes','chickoo','banana','mango','apple']
...
middleitem = len(lst1)//2
middleitem = lst1[middleitem]
print(middleitem)

lastitem = len(lst1)-1
lastitem = lst1[lastitem]
print(lastitem)
...
it_companies.append('softweb')            


# Insert an IT company in the middle of the companies list
middlecom = len(it_companies)//2
it_companies.insert(middlecom,'civica')
...
if 'Apple' in it_companies:
    print("Apple is in the list of IT companies.")
else:
    print("Apple is not in the list of IT companies.")
